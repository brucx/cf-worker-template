/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: b72703ac48869de2cf2c643cc1e213d9)
// Runtime types generated with workerd@1.20250829.0 2024-04-03 
declare namespace Cloudflare {
	interface Env {
		WORKER_URL: "http://localhost:8787";
		SERVER_STALE_THRESHOLD: 30000;
		SERVER_CLEANUP_INTERVAL: 30000;
		JWT_SECRET: string;
		TASK_INSTANCE: DurableObjectNamespace<import("./src/index").TaskInstanceDO>;
		LOAD_BALANCER: DurableObjectNamespace<import("./src/index").LoadBalancerDO>;
		SERVER_INSTANCE: DurableObjectNamespace<import("./src/index").ServerInstanceDO>;
		SERVER_REGISTRY: DurableObjectNamespace<import("./src/index").ServerRegistryDO>;
		TASK_STATS: DurableObjectNamespace<import("./src/index").TaskInstanceStatsDO>;
		TASK_DATABASE: D1Database;
	}
}
