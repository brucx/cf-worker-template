/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 62c76fd5460d20687e1792bb31700c3b)
// Runtime types generated with workerd@1.20250829.0 2025-03-17 
declare namespace Cloudflare {
	interface Env {
		JWT_SECRET: string;
		SERVER_REGISTRY: DurableObjectNamespace<import("./src/index").ServerRegistry>;
		TASK_MANAGER: DurableObjectNamespace<import("./src/index").TaskManager>;
		SERVER_INSTANCE: DurableObjectNamespace<import("./src/index").ServerInstance>;
